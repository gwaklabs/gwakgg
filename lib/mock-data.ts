...
export const mockSignals: Signal[] = [
  ...
  },
  {
    ...
    entry: 184.2,
    liquidation: 176.84,
    openedAt: new Date(Date.now() - 3 * 60_000).toISOString(),
    venue: "Hyperliquid",
    chips: [
  ...
  },
  {
    ...
    entry: 3_420,
    liquidation: 3_762,
    openedAt: new Date(Date.now() - 1 * 60_000).toISOString(),
    venue: "Hyperliquid",
